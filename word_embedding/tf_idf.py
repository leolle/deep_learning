...
dictionary.save(
    '/tmp/tweets.dict')  # store the dictionary, for future reference
print("We create a dictionary, an index of all unique values: %s" %
      type(dictionary))
...
print("We get a similarity matrix for all documents in the corpus %s" %
      type(sims))
print()
