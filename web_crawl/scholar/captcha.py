...
def _handle_captcha(url):
    ...
    url_response = _HOST + '/sorry/CaptchaRedirect?continue={0}&id={1}&captcha={2}&submit=Submit'.format(
...
class Publication(object):
    ...
    def __init__(self, __data, pubtype=None):
        ...
        if self.source == 'citations':
            ...
            self.id_citations = re.findall(
                _CITATIONPUBRE, __data.find('a',
                                            class_='gsc_a_at')['data-href'])[0]
            ...
            if year and year.text and not year.text.isspace() and len(
                    year.text) > 0:
            ...
            for link in lowerlinks:
                ...
                if 'Cited by' in link.text:
                    ...
                    self.id_scholarcitedby = re.findall(_SCHOLARPUBRE,
                                                        link['href'])[0]
...
class Author(object):
    ...
    def __init__(self, __data):
        if isinstance(__data, str):
            ...
            self.interests = [
                i.text.strip()
                for i in __data.find_all('a', class_='gsc_oai_one_int')
            ]
